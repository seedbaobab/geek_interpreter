...
from analyzer.syntax.tree.v1.provider_call_leaf import ProviderCallLeaf
...
class ProviderCallGrammar(SequentialGrammar, ABC):
    ...
    def __set_identifier(self, branch: ProviderCallLeaf, leaf: AbstractTree, target: Target):
    ...
    def __set_service_call(self, branch: ProviderCallLeaf, leaf: AbstractTree, target: Target):
